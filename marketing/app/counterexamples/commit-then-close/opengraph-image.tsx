...
export const alt = openGraphCards["/counterexamples/commit-then-close"].title;
export const size = openGraphSize;
export const contentType = openGraphContentType;

export default function Image() { return createOpenGraphCard(openGraphCards["/counterexamples/commit-then-close"]); }
